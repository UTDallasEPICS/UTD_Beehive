...
while bool("True"):  # Will run forever
    ...
    for line in HiveIPList:  # For statment reads each line of the beehive ip file
        ...
        try:  # Try statement in case the IP is unresponsive
            ...
            time.sleep(1)  # Set delay for the next IP it scrapes. Only change if it is collecting data to fast or want to make it run slower to save battery life if they are solar powered
        except:
